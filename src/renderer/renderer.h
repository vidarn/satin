...
GRAPHICS_VALUE_TYPE(TEX2,   1,sizeof(int))\
GRAPHICS_VALUE_TYPE(SPRITE, 1,sizeof(int))\
GRAPHICS_VALUE_TYPE(SPRITE_POINTER, 1, sizeof(void *))
...
static const int graphics_value_sizes[] = {
#define GRAPHICS_VALUE_TYPE(name,num,size) num*size,
    GRAPHICS_VALUE_TYPES
#undef GRAPHICS_VALUE_TYPE
};

static const int graphics_value_nums[] = {
